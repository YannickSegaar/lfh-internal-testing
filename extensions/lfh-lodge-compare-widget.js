/**
 * Last Frontier Lodge Compare - In-Chat Widget
 *
 ...
 *
 * Triggers on VoiceFlow trace: ext_lodgeCompare
 *
 * @version 2.0.0
 * @author Last Frontier Heliskiing / RomAIx
 */

import { LFH_LODGES, LFH_COLORS, LFH_ASSETS, openLodgeCompareModal } from './lfh-lodge-compare-modal.js';

export const LFHLodgeCompareWidget = {
  name: 'LFHLodgeCompareWidget',
  type: 'response',
...
export default LFHLodgeCompareWidget;

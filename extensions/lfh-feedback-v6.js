...
export const FeedbackExtension6 = {
  name: 'Feedback',
  type: 'response',
  match: ({ trace }) => trace.type === 'ext_feedback6' || trace.payload?.name === 'ext_feedback6',
  render: ({ trace, element }) => {
    ...
    feedbackContainer.innerHTML = `
      ...
      <div class="romaix-feedback">
        ...
        <div class="romaix-feedback__comment-section">
          ...
          <div class="romaix-feedback__timer"></div>
    ...
    const timerDisplay = feedbackContainer.querySelector('.romaix-feedback__timer');
    ...
    function startCountdown(seconds) {
      ...
      const updateTimer = () => {
        timerDisplay.textContent = `Submitting in ${timeLeft}s...`;
      };
    ...
    commentInput.addEventListener('input', () => {
      if (!userHasTyped && commentInput.value.trim().length > 0) {
        ...
        timerDisplay.textContent = 'Click "Submit Now" when ready';
      }
    });
...
export default FeedbackExtension6;

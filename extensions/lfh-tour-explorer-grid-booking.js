/**
 * Last Frontier Tour Explorer - Grid with Booking
 *
...
import { openTourExplorerModalWithBooking } from './lfh-tour-explorer-modal-booking.js';

export const LFHTourExplorerGridBooking = {
  name: 'LFHTourExplorerGridBooking',
  type: 'response',

  match: ({ trace }) =>
    trace.type === 'ext_tourExplorer_booking' ||
    trace.type === 'ext_tourExplorer_grid_booking' ||
    trace.payload?.name === 'ext_tourExplorer_booking' ||
...
export default LFHTourExplorerGridBooking;

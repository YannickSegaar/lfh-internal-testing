...
export const FeedbackExtension7 = {
  name: 'Feedback',
  type: 'response',
  match: ({ trace }) => trace.type === 'ext_feedback7' || trace.payload?.name === 'ext_feedback7',
  render: ({ trace, element }) => {
    ...
    commentInput.addEventListener('input', () => {
      if (!userHasTyped && commentInput.value.trim().length > 0) {
        ...
        // Replace dots with helpful message
...
export default FeedbackExtension7;
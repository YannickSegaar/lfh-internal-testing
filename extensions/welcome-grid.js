/**
 * Last Frontier Welcome Grid Extension (V6 Onboarding)
 *
 * Displays a 2x2 visual grid of branded image cards on chat open,
 * merging carousel visuals (V2) with path selector UX (V4).
 * Compact, visual, actionable — no horizontal scrolling needed.
 *
 * Trace type: ext_welcomeGrid
 * Payload: (none required)
 *
 * @version 1.0.0
 */

export const LastFrontierWelcomeGrid = {
  name: 'LastFrontierWelcomeGrid',
  type: 'response',

  match: ({ trace }) =>
    trace.type === 'ext_welcomeGrid' ||
    trace.payload?.name === 'ext_welcomeGrid',
...
export default LastFrontierWelcomeGrid;

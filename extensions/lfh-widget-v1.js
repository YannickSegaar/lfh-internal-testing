// YRS: LEAD FORM EXTENSION FOR LAST FRONTIER HELISKIING - WIDGET OPTIMIZED - VERSION 1 (20 JAN 2026 - 13:33 CEST)

export const LastFrontierHeliskiingLeadForm_Widget1 = {
  name: 'LastFrontierHeliskiingLeadForm_Widget1',
  type: 'response',
  match: ({ trace }) =>
    trace.type === 'ext_lastFrontierHeliskiingLeadForm_Widget1' ||
    trace.payload?.name === 'ext_lastFrontierHeliskiingLeadForm_Widget1',
  render: ({ trace, element }) => {
    ...
    wrapper.style.cssText = `
      ...
      box-shadow: 0 4px ${shadowSize} ${shadowColor}, 0 0 0 1px rgba(255,255,255,0.1);
      height: ${height}px;
      display: flex;
    ...
    if (animateIn) {
      ...
      wrapper.style.transform = 'translateY(10px) scale(0.98)';
    ...
    wrapper.innerHTML = `
      <style>
        ...
        .form-group textarea:focus {
          outline: none;
          border-color: ${primaryColor};
          box-shadow: 0 0 0 3px rgba(238, 45, 36, 0.12);
          background: ${accentColor};
        ...
        .lodge-card:hover {
          border-color: ${primaryColor};
          transform: translateY(-1px);
          box-shadow: 0 3px 10px rgba(238, 45, 36, 0.12);
        }
        ...
        input[type="range"]::-webkit-slider-thumb {
          ...
          background: ${primaryColor};
          cursor: pointer;
          box-shadow: 0 2px 6px rgba(238, 45, 36, 0.3);
        }
        ...
        .success-icon {
          ...
          align-items: center;
          justify-content: center;
          box-shadow: 0 4px 16px rgba(238, 45, 36, 0.3);
        }
        ...
        .btn-primary {
          background: linear-gradient(135deg, ${primaryColor} 0%, #c51e15 100%);
          color: white;
          box-shadow: 0 3px 10px rgba(238, 45, 36, 0.3);
        }

        .btn-primary:hover {
          transform: translateY(-2px);
          box-shadow: 0 5px 16px rgba(238, 45, 36, 0.4);
        }
...
export default LastFrontierHeliskiingLeadForm_Widget1;

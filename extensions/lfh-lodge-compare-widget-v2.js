...
import { LFH_LODGES, LFH_COLORS, LFH_ASSETS, openLodgeCompareModal } from './lfh-lodge-compare-modal-v2.js';

export const LFHLodgeCompareWidgetV2 = {
  name: 'LFHLodgeCompareWidgetV2',
  type: 'response',
...
export default LFHLodgeCompareWidgetV2;

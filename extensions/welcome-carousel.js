/**
 * Last Frontier Welcome Carousel Extension (V2 Onboarding)
 *
...
export const LastFrontierWelcomeCarousel = {
  name: 'LastFrontierWelcomeCarousel',
  type: 'response',

  match: ({ trace }) =>
    trace.type === 'ext_welcomeCarousel' ||
    trace.payload?.name === 'ext_welcomeCarousel',
    ...
    container.querySelectorAll('.lfh-welcome-card').forEach(card => {
      card.addEventListener('click', () => {
        ...
        const actionMessages = {
          show_lodges: 'Show me the lodges',
          show_tours: 'Show me the tour options',
          show_self_service: 'I want to watch the videos',
          plan_trip: 'Help me plan my trip'
        };
...
export default LastFrontierWelcomeCarousel;

/**
 * Last Frontier Lead Capture Form Extension v3
 *
 * Refined styling following Steve's guidelines and MailChimp template.
 * Features improved lead qualification with intent capture and priority scoring.
 *
 * Key changes from v2:
 * - Dark wood texture header with white logo band (matching email template style)
 * - Ghost-style primary buttons (white bg, red border)
 * - Direct "What brings you here?" intent qualifier
 * - Visual clickable season cards
 * - Computed lead priority scoring (cold/warm/hot)
 *
 * v3.0.1 Changes:
 * - Added conversational intent signals from AI conversation
 * - Intent signals passed via payload for team lead prioritization
 * - Tracks: intentLevel, hasTimeline, groupComposition, priorExperience,
 *   askedLogistics, askedBookingProcess, and conversationSummary
 *
 * @version 3.0.1
 * @author Last Frontier Heliskiing / RomAIx
 */

export const LastFrontierLeadForm_v3 = {
  name: 'LastFrontierLeadForm_v3',
  type: 'response',

  match: ({ trace }) =>
    trace.type === 'ext_lastFrontierLeadForm_v3' ||
    trace.payload?.name === 'ext_lastFrontierLeadForm_v3',
  ...
  render: ({ trace, element }) => {
    ...
    const {
      ...
      webhookUrl = 'https://n8n.romaix-n8n.xyz/webhook/last-frontier-lead-v3',
    ...
    container.innerHTML = `
      <style>
        ...
        /* ===== HEADER - White logo band + dark label section ===== */
        .lfh-v3-header {
          text-align: center;
          overflow: hidden;
        }

        /* White band for logo - full width */
        .lfh-v3-logo-band {
          background: #FFFFFF;
          padding: 14px 16px;
        }
        ...
        /* Dark section for the label */
        .lfh-v3-header-label-section {
          background-image: url('https://yannicksegaar.github.io/RomAIx-Logo/bg_content_and_image.png');
          background-size: cover;
          background-position: center;
          position: relative;
        }

        .lfh-v3-header-label-overlay {
      ...
      <div class="lfh-v3-header">
        <div class="lfh-v3-logo-band">
          <img
            src="https://yannicksegaar.github.io/RomAIx-Logo/LastFrontierHeliskiing_Logo_FullName.svg"
            alt="Last Frontier Heliskiing"
            class="lfh-v3-logo"
          />
        </div>
        <div class="lfh-v3-header-label-section">
          <div class="lfh-v3-header-label-overlay">
            <p class="lfh-v3-header-label">Inquiry Form</p>
          </div>
        </div>
      </div>
      ...
      <div class="lfh-v3-content">
          ...
          <form id="lfh-v3-contact-form">
            <div class="lfh-v3-form-row">
              <div class="lfh-v3-form-group">
                ...
                <input type="text" id="lfh-v3-firstName" name="firstName" class="lfh-v3-input" placeholder="John" required>
              </div>
              <div class="lfh-v3-form-group">
                <label class="lfh-v3-label">Last Name <span class="lfh-v3-required">*</span></label>
                <input type="text" id="lfh-v3-lastName" name="lastName" class="lfh-v3-input" placeholder="Smith" required>
              </div>
            </div>

            <div class="lfh-v3-form-group">
              <label class="lfh-v3-label">Email <span class="lfh-v3-required">*</span></label>
              <input type="email" id="lfh-v3-email" name="email" class="lfh-v3-input" placeholder="john.smith@example.com" required>
            </div>

            <div class="lfh-v3-form-group">
              <label class="lfh-v3-label">Phone <span class="lfh-v3-required">*</span></label>
              <input type="tel" id="lfh-v3-phone" name="phone" class="lfh-v3-input" placeholder="+1 (888) 655 5566" required>
            </div>

            <div class="lfh-v3-form-group">
              <label class="lfh-v3-label">Country <span class="lfh-v3-required">*</span></label>
              <select id="lfh-v3-country" name="country" class="lfh-v3-select" required>
            ...
            <div class="lfh-v3-form-group">
              ...
              <input type="text" id="lfh-v3-city" name="city" class="lfh-v3-input" placeholder="Vancouver">
            </div>
        ...
        <div id="lfh-v3-step-2" class="lfh-v3-step">
          <form id="lfh-v3-trip-form">
            ...
            <!-- PREFERRED DATES -->
            <div class="lfh-v3-form-group">
              <label class="lfh-v3-label">Preferred dates</label>
              <input type="text" id="lfh-v3-preferredDates" name="preferredDates" class="lfh-v3-input" placeholder="e.g., February 15-25, 2027">
            </div>
            ...
            <div class="lfh-v3-form-group">
              ...
              <div class="lfh-v3-lodge-cards">
                <label class="lfh-v3-lodge-card" for="lodge-bell2">
                  ...
                  <div class="lfh-v3-lodge-name"><span class="lfh-v3-lodge-icon">&#127968;</span> Bell 2 Lodge</div>
                ...
                <label class="lfh-v3-lodge-card" for="lodge-ripley">
                  ...
                  <div class="lfh-v3-lodge-name"><span class="lfh-v3-lodge-icon">&#127976;</span> Ripley Creek</div>
                ...
                <label class="lfh-v3-lodge-card" for="lodge-both">
                  ...
                  <div class="lfh-v3-lodge-name"><span class="lfh-v3-lodge-icon">&#128506;</span> Both (Safari)</div>
    ...
    async function submitToWebhook() {
      ...
      const payload = {
        ...
        tripPreferences: {
          ...
          preferredDates: getVal('#lfh-v3-preferredDates'),
        ...
        // Intent signals detected during conversation (before form was shown)
        ...
        source: 'Voiceflow Lead Form v3',
        formVersion: '3.0.1',
      };

      console.log('Submitting lead form v3 payload:', JSON.stringify(payload, null, 2));
      ...
      try {
        ...
        console.log('Lead form v3 submitted successfully');
        return true;
      } catch (error) {
        console.error('Lead form v3 submission error:', error);
        // Still return true to show success (data logged to console for debugging)
        return true;
      }
    }
      ...
      if (currentStep === 1) {
        ...
        if (success) {
          ...
          window.voiceflow?.chat?.interact({
            type: 'complete',
            payload: {
              action: 'lead_captured_v3',
              leadPriority: computeLeadPriority(
...
export default LastFrontierLeadForm_v3;

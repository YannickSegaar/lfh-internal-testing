...
function interactWithAgent(type, payload) {
  try {
    ...
    console.log('[TourExplorerBooking] interact:', type, payload);
  }
}
 ...
 */
export function openTourExplorerModalWithBooking(focusTourId = null, config = {}) {
  ...
  function handleBookingSuccess(tour, payload) {
    // Fire interact event for VoiceFlow
    interactWithAgent('booking_request_submitted', {
      tourId: tour.id,
      tourName: tour.name,
  ...
  document.addEventListener('keydown', function escHandler(e) {
    if (e.key === 'Escape' && document.getElementById('lfh-tour-explorer-modal')) {
      ...
      if (!document.getElementById('lfh-tour-explorer-modal')) {
